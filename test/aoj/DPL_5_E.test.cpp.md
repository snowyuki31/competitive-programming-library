...
data:
  ...
  attributes:
    ...
    document_title: Twelvefold way V
    links:
  ...
  bundledCode: "#line 1 \"test/aoj/DPL_5_E.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_E\"\
    ...
    \     Binomial(int N) : _N(N + 1), _M(mint::mod()), D(min(_N, _M)), fac(D), finv(D),\
    \ inv(D) {\n            fac[0] = fac[1] = 1;\n            finv[0] = finv[1] =\
    \ 1;\n            inv[1] = 1;\n            for (int i = 2; i < D; ++i) {\n   \
    \             fac[i] = fac[i - 1] * i;\n                inv[i] = _M - inv[_M %\
