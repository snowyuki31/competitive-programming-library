...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder/1035.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1035\"\
    ...
    \ snow\n#line 6 \"test/yukicoder/1035.test.cpp\"\nusing mint = atcoder::modint1000000007;\n\
    \n/**\n * @brief Twelvefold way III\n * \n */\nint main() {\n    int N, M;\n \
    \   std::cin >> N >> M;\n    snow::Binomial<mint> binom(N);\n    mint ans = 0;\n\
    \    for(int i = 0; i <= M; ++i){\n        ans += mint(M - i).pow(N) * binom.get(M,\
    \ i) * (i % 2 ? -1 : 1);\n    }\n    std::cout << ans.val() << '\\n';\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1035\"\n\n#include <iostream>\n\
    ...
    int main() {\n    int N, M;\n    std::cin >> N >> M;\n    snow::Binomial<mint>\
    \ binom(N);\n    mint ans = 0;\n    for(int i = 0; i <= M; ++i){\n        ans\
    \ += mint(M - i).pow(N) * binom.get(M, i) * (i % 2 ? -1 : 1);\n    }\n    std::cout\
    \ << ans.val() << '\\n';\n}"
  dependsOn:
  - atcoder/modint.hpp
  ...
  verifiedWith: []
documentation_of: test/yukicoder/1035.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder/1035.test.cpp
- /verify/test/yukicoder/1035.test.cpp.html
