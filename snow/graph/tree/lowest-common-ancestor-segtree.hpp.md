...
data:
  ...
  attributes:
    document_title: "Lowest Common Ancestor Segtree ver. - \u524D\u51E6\u7406$O(N\\\
      log N), $O(\\logN)$"
    links: []
  bundledCode: "#line 2 \"snow/graph/tree/lowest-common-ancestor-segtree.hpp\"\n\n\
    ...
    \n\nnamespace snow {\n\n/**\n * @brief Lowest Common Ancestor Segtree ver. - \u524D\
    ...
    \ id->order\n        std::vector<int> id;    // order->id\n        snow::segtree<snow::min_monoid<std::pair<int,\
    \ int>>> segtree;\n\n        int order = 0;\n        void euler_tour(snow::Graph<T>\
...
title: "Lowest Common Ancestor Segtree ver. - \u524D\u51E6\u7406$O(N\\log N), $O(\\\
  logN)$"
---
